    ...
    <div class="col-md-12">
        ...
        <div class="content-box">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <select class="form-control input-sm" id="caripembayaran">
                        <option value=""> -- Keseluruhan -- </option>
                ...
                <div class="col-sm-6 col-lg-4">
                    <select class="form-control input-sm" id="carimarketing">
                        <option value=""> -- Keseluruhan -- </option>
                        {{ App\Marketing::opsi() }}
                    </select>
                </div>
                ...
                <form class="form form-horizontal" id="form">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-5">Harga Standart</label>
                                <div class="col-sm-7">
                                    <div class="input-group input-append">
                                        <span class="input-group-addon add-on">Rp.</span>
                            ...
                            <div class="form-group row input-kredit">
                                <label class="col-form-label col-sm-5">Tgl Wawancara</label>
                                <div class="col-sm-7">
                                    <div class="input-group input-append date">
                                        <input type="text" class="form-control input-sm text-center" name="txttglwawancara" id="txttglwawancara">
                                        <span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span>
                                    </div> 
                                </div>
                            </div>
                            <div class="form-group row input-kredit">
                                <label class="col-form-label col-sm-5">Tgl Sp3k</label>
                                <div class="col-sm-7">
                                    <div class="input-group input-append date">
                                        <input type="text" class="form-control input-sm text-center" name="txttglsp3k" id="txttglsp3k">
                                        <span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span>
                                    </div> 
                                </div>
                            </div>
                            <div class="form-group row input-kredit">
                                <label class="col-form-label col-sm-5">Tgl Akad</label>
                                <div class="col-sm-7">
                                    <div class="input-group input-append date">
                                        <input type="text" class="form-control input-sm text-center" name="txttglakad" id="txttglakad">
                                        <span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span>
                                    </div> 
                                </div>
                            </div>
...
<script type="text/javascript" src="{{ url('scripts/data_penjualan.js') }}"></script>
