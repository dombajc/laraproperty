    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="titlemodel">PROSES PEMBATALAN</h4>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-append">
                                        <input type="text" class="form-control input-sm" id="txttipe" disabled>
                                        <span class="input-group-addon add-on">Proyek</span>
                                        <input type="text" class="form-control input-sm" id="txtproyek" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="{{ url('scripts/entry_pembatalan.js') }}"></script>
